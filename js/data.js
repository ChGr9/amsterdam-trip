...
const TRIP = {
  ...
  days: [
    ...
    },
    {
      date: "2026-08-22",
      label: "Day 3",
      theme: "Dutch GP — Sprint & Qualifying 🏎️",
      desc: "Sprint weekend! Times from the official F1 timetable (local, subject to change). It gets PACKED — leave early.",
      items: [
        ...
        { time: "09:20", end: "09:50", title: "F1 Academy — Qualifying", cat: "sight",
          desc: "First session of the day — only if we catch the early train.",
          location: "Circuit Zandvoort",
          url: "https://www.dutchgp.com/en/" },
        { time: "10:15", end: "10:45", title: "Porsche Supercup — Qualifying", cat: "sight" },
        { time: "12:00", end: "12:30", title: "🏁 F1 SPRINT (24 laps)", cat: "sight", booked: true,
          desc: "Saturday's main event #1. Earplugs in, sunscreen on — it's on the coast, rain layer too." },
        { time: "14:35", end: "15:10", title: "F1 Academy — Reverse Grid Race", cat: "sight",
          desc: "Good window for food or a beach break if we'd rather skip it." },
        { time: "16:00", end: "17:00", title: "🏁 F1 QUALIFYING", cat: "sight", booked: true,
          desc: "Saturday's main event #2 — grid positions for Sunday." },
        { time: "18:00", end: "18:35", title: "Porsche Supercup — First Race", cat: "sight",
          desc: "Optional — staying for it also lets the train queues thin out." },
        { time: "18:45", title: "Train back + dinner", cat: "food",
    ...
    },
    {
      ...
      desc: "The big one. Times from the official F1 timetable (local, subject to change). Even busier than Saturday.",
      items: [
        { time: "08:30", title: "Train to Zandvoort aan Zee", cat: "travel",
          desc: "Go early — race day crowds are the biggest of the weekend.",
          location: "Amsterdam Centraal" },
        { time: "10:30", end: "11:05", title: "F1 Academy — Feature Race", cat: "sight",
          location: "Circuit Zandvoort",
          url: "https://www.dutchgp.com/en/" },
        { time: "11:45", end: "12:20", title: "Porsche Supercup — Second Race", cat: "sight",
          desc: "Lunch window after this one — before the parade starts." },
        { time: "13:00", end: "13:30", title: "F1 Drivers' Parade", cat: "sight",
          desc: "All 20 drivers do a lap — get to a good viewing spot." },
        { time: "14:44", title: "National Anthem", cat: "sight",
          desc: "Be in your seats by ~14:30 — nobody moves during the pre-race ceremony." },
        { time: "15:00", end: "17:00", title: "🏁 FORMULA 1 GRAND PRIX (72 laps)", cat: "sight", booked: true,
          desc: "THE race. Beach is right there if anyone needs a break from the noise before it starts." },
        { time: "17:15", title: "Head back & dinner", cat: "food",
          desc: "Everyone leaves at once — either brave the queue or have dinner at a beach pavilion in Zandvoort while the crowds clear." }
      ]
    },
    {
      date: "2026-08-24",
